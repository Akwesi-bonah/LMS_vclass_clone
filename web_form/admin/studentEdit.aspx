<%@ Page Title="" Language="C#" MasterPageFile="~/web_form/views/Admin.Master" AutoEventWireup="true" CodeBehind="studentEdit.aspx.cs" Inherits="vclass_clone.web_form.admin.studentEdit" %>
               ...
               <div class="row justify-content-center">
                   <div class="col-md-8">
                       <div class="card centered-form">
                           ...
                           <div class="card-body">
                            <asp:HiddenField ID="hstuId" runat="server" />
                               ...
                               <div class="row">
                                   <div class="col-md-6">
                                       <asp:Button ID="btnUptStu" runat="server" Text="Save" CssClass="btn btn-primary"  Width="140px" OnClick="btnUptStu_Click" />
                                   </div>
