<%@ Page Title="" Language="C#" MasterPageFile="~/web_form/views/Admin.Master" AutoEventWireup="true" CodeBehind="FacilitatorEdit.aspx.cs" Inherits="vclass_clone.web_form.admin.FacilitatorEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
       ...
       <div class="row">
           <div>
               <asp:Button runat="server" Text="Go Back" ID="goBack" CssClass="btn btn-success font-weight-bold" OnClick="goBack_Click" Height="51px" Width="93px" />
           </div>
           <br />
                   ...
                   <div class="col-md-8">
                       <div class="card centered-form">
                           ...
                           <div class="card-body">
                               ...
                               <div class="row">
                                   <div class="col-md-6">
                                       <asp:Button ID="btnEditFac" runat="server" Text="Save" CssClass="btn btn-primary" OnClick="btnEditFac_Click" />
                                   </div>
